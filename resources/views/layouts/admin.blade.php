...
<!-- <link rel="stylesheet" href="{{asset('ad/css/jqvmap.css')}}" > -->
<!-- <link rel="stylesheet" href="{{asset('ad/css/lightbox.css')}}" > -->
<!-- <link rel="stylesheet" href="{{asset('ad/css/minimal.css')}}" > -->
<!-- //bootstrap-css -->
<!-- Custom CSS -->
...
<!-- <link rel="stylesheet" href="{{asset('ad/css/morris.css')}}" type="text/css"/> -->
<!-- calendar -->
<!-- <link rel="stylesheet" href="{{asset('ad/css/monthly.css')}}"> -->
<!-- //calendar -->
<!-- //font-awesome icons -->
    ...
    <ul class="nav top-menu">
        ...
        <li id="header_inbox_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="{{asset('ad/images/3.png')}}"></span>
                                <span class="subject">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="{{asset('ad/images/1.png')}}"></span>
                                <span class="subject">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="{{asset('ad/images/2.png')}}"></span>
                                <span class="subject">
...
<div class="top-nav clearfix">
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img alt="" src="{{asset('ad/images/2.png')}}">
                <span class="username">handsome kang</span>
                <b class="caret"></b>
            </a>
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{url('admin/user')}}">查看管理员</a></li>
...
<!-- wai -->
<!-- <script src="{{asset('ad/js/jquery.vmap.js')}}"></script> -->
<!-- <script src="{{asset('ad/js/jquery.vmap.sampledata.js')}}"></script> -->
<!-- <script src="{{asset('ad/js/jquery.vmap.world.js')}}"></script> -->
<!-- <script src="{{asset('ad/js/monthly.js')}}"></script> -->
<!-- end -->
